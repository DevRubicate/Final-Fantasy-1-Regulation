...
; address 228 - 229 (bytes 0 - 1)
LUT_MAP_METATILES_LO:
.byte <MAP_0_METATILES

; address 229 - 230 (bytes 0 - 1)
LUT_MAP_METATILES_HI:
.byte >MAP_0_METATILES

; address 230 - 236 (bytes 0 - 6)
MAP_0_METATILES:
.byte <METATILE_GRASS, >METATILE_GRASS, <METATILE_WATER, >METATILE_WATER, $ff, $ff
