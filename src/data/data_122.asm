...
; address 227 - 229 (bytes 0 - 2)
LUT_METATILE_FRAMES_LO:
.byte <METATILE_GRASS_FRAMES, <METATILE_WATER_FRAMES

; address 229 - 231 (bytes 0 - 2)
LUT_METATILE_FRAMES_HI:
.byte >METATILE_GRASS_FRAMES, >METATILE_WATER_FRAMES

; address 231 - 248 (bytes 0 - 17)
METATILE_GRASS_FRAMES:
.byte >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_1, <TILE_CURSOR_1, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_1, <TILE_CURSOR_1, >TILE_CURSOR_1, <TILE_CURSOR_1, >TILE_CURSOR_1, <TILE_CURSOR_1, >TILE_CURSOR_1, <TILE_CURSOR_1, >TILE_CURSOR_1, <TILE_CURSOR_1, $ff

; address 248 - 265 (bytes 0 - 17)
METATILE_WATER_FRAMES:
.byte >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, >TILE_CURSOR_0, <TILE_CURSOR_0, $ff
