...
.export TEXT_TEMPLATE_ITEM_LIST, TEXT_SHOP_WELCOMEWOULDYOUSTAY, TEXT_SHOP_TOOBAD, TEXT_SHOP_YOUHAVETOOMANY, TEXT_SHOP_WHATDOYOUWANT, TEXT_TITLE_COPYRIGHT_NINTENDO, TEXT_CLASS_NAME_FIGHTER, TEXT_CLASS_NAME_KNIGHT, TEXT_SHOP_TITLEBLACKMAGIC, TEXT_ITEM_NAME, LUT_METASPRITE_PALETTE, LUT_METASPRITE_PALETTE_SIBLING2, METASPRITE_CURSOR_PALETTE
