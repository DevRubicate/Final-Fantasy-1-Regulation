...
.import WaitForVBlank, MusicPlay, PrepAttributePos
.import UpdateJoy, DialogueBox_Sfx, CoordToNTAddr, WaitScanline, Dialogue_CoverSprites_VBl

.export PrepDialogueBoxRow, ShowDialogueBox, EraseBox, DialogueBox_Frame
