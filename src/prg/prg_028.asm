...
.import PlaySFX_Error, AddGPToParty, DrawComplexString_New
...
.import SortEquipmentList, UnadjustEquipStats, DrawSimple2x3Sprite, lutClassBatSprPalette, LoadNewGameCHRPal
...
.export EnterMainMenu, EnterTitleScreen, EnterIntroStory
