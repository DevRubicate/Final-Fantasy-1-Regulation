...
; bank_1E_util
.import DisableAPU, ClearOAM, Dialogue_CoverSprites_VBl, UpdateJoy, PrepAttributePos, CoordToNTAddr, SetPPUAddrToDest
; bank_18_screen_wipe
...
.export DialogueBox_Frame, LoadOWMapRow, PrepRowCol, ScrollUpOneRow
...
DrawImageRect:
    FARCALL CoordToNTAddr    ; convert the given destination to a usable PPU address
