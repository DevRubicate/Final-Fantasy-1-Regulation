 ...
 * @returns {Array} Array of NES color objects with id, r, g, b properties
 */
export function buildNESPalette() {
    const palette = [
 ...
 * @param {Array} nesPalette - The NES palette array
 * @param {number} r - Red component (0-255)
 * @param {number} g - Green component (0-255)
 * @param {number} b - Blue component (0-255)
 * @returns {Object} - Closest NES color with id and RGB values
 */
export function findClosestNESColor(nesPalette, r, g, b) {
