...
export const COMMANDS = {
    ...
    PLOT_BITS: 0x01,       // Plot a 4-bit pattern (4 bit pattern)
    REPEAT_COMMAND: 0x02   // Repeat the following command 2-9 times (3 bit count)
};
...
export const COMPRESSION = {
    MAX_REPEAT_COUNT: 9,
    MIN_REPEAT_COUNT: 2,
    COMMAND_BIT_WIDTHS: [1, 2], // Supported command bit widths
    MAX_RUN_LENGTH: 9
};